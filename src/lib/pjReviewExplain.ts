...
export function explainReviewRow(row: PjSyncReviewRow, ctx: PjReviewContext | null): string {
  switch (row.reason) {
    ...
    case 'PLAN_CHANGE_REVIEW':
      return 'ร้านเปลี่ยนแผนผ่อนหรือวันชำระของสัญญานี้ใน PJ — เคสนี้ซับซ้อนเกินกว่าระบบจะเลื่อนวันให้เองได้ กรุณาดูตารางเทียบงวดด้านล่าง แล้วไปแก้ข้อมูลที่หน้าสัญญาด้วยตัวเอง'
    case 'PLAN_CHANGE_DRYRUN':
